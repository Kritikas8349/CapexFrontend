      ...
      <div className="contact-section-unique">
        {[
          ...
          <div className="contact-card-unique" key={i}>
            <img 
              src={`https://img.icons8.com/ios-filled/100/0073e6/${item.icon}.png`} 
              alt={item.title}
      ...
      <div className="enquiry-container">
        <div className="enquiry-left">
          ...
          <form className="enquiry-form" onSubmit={handleSubmit}>
            ...
            <textarea name="message" value={formData.message} onChange={handleChange} placeholder="How can we help?" required></textarea>
