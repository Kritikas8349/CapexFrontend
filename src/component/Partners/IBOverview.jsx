    ...
    return (
        <div>
            <div className="d-flex align-items-center text-white" style={{
                backgroundImage: "url('/compliance.avif')",
                        ...
                        <div className="col-12 col-lg-6 bg-transparent">
                            <div className="content-box p-4 p-md-5 bg-transparent"> {/* Add responsive padding */}
                                ...
                                <div className='d-flex gap-1'>
                                    ...
                                    <button className="btn btn-bg-start text-white btn-lg fw-bold">Partner Now</button> {/* btn-lg for a larger button */}
            ...
            <div className="container-fluid  py-5 bg-dark ">
                <div className="row align-items-center py-4  px-lg-5">

                    {/* Left Column */}
                    <div className="col-12 col-md-6 col-lg-6 mb-4 mb-md-0">
                        <h2 className="text-primary fs-1 fw-bold mb-4">
                            Why partner<br />
                    ...
                    <div className="col-12 col-md-6 col-lg-6 ">
                        <h5 className='text-light lh-base'>Partnering with BlackBull Markets offers unlimited earning potential, competitive rebates, and custom structures to suit your needs. You’ll also benefit from advanced tracking tools, marketing resources, and support from a personal Account Manager.</h5>
                    </div>

                </div>
            </div>
            {/* ------------------- */}
            <section className="container align-content-center  my-5" style={{ height: '85vh' }}>
            ...
            <section className="container-fluid bg-primary-subtle border border-bottom border-primary py-5">
                <div className="row align-items-center g-5">
                    {/* Text Column */}
                    <div className="col-lg-6">
                        <h2 className="display-5 fw-bold mb-4 text-center text-lg-start">
                                ...
                                <div key={index} className="col-12 col-sm-6">
                                    <div className="card h-100 text-center shadow-sm border-0 p-4">
                                        <div className="card-body d-flex flex-column justify-content-center">
                                            {card.icon && (
                                                <i className={`${card.icon} fs-2 text-primary mb-3`}></i>
                                            )}
            ...
            {/* -------Who Should join ------------ */}
            <section className="container-fluid bg-primary-subtle py-5">
                <div className="row align-items-center g-5">
                    {/* Cards Column */}
                    <div className="col-lg-6">
                        <div className="row g-4 justify-content-center">
            ...
            {/* ------Convert More Client ------- */}
            <section className="container-fluid border border-3 border-black  bg-dark-subtle py-5">
                <div className="row align-items-center g-5 py-4">
                    ...
                    <div className="col-lg-6">
                        ...
                        <button className='btn btn-success'>Partner Now</button>
                    </div>
            ...
            <div className="container-fluid py-5 bg-light">
                <div className="container">
                    <h1 className='text-center fw-bold'>How to join <span className='text-primary'>Market Trad Partners?</span></h1>
                    {/* --Step1-- */}
                    <div className="row align-items-center py-3">

                        {/* Image - Left on desktop, top on mobile */}
                        <div className="col-lg-6 col-md-12 mb-4 mb-lg-0 text-center bg-primary-subtle p-4">
                            <img
                                src="/mobile2.webp"
                                alt="Create Account"
                                className="img-fluid"
      ...
      <h2 className="text-center fw-bold mb-4">Partner Commission Plan</h2>
              ...
              <>
                {row.category && (
                  <tr key={`cat-${index}`}>
                    <td
                      colSpan={4}
                      className="fw-bold text-white bg-black text-center"
                    >
                      {row.category}
                    </td>
                  </tr>
