            ...
            <section className="m-section">
                <div className="m-content">
                    ...
                    <p className="m-description">
                        CFD futures offer the opportunity to trade based on the future price of an asset such as commodities, indices, and currencies. Trade Futures with BlackBull Markets with just a fraction of the capital.
