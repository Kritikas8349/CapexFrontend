...
function QuickStart4() {
    ...
    return (
        <div id='Main'>
            ...
            {/* Account cards */}
            {[1, 2, 3].map((num) => (
                <div className={`standard-account${num > 1 ? num : ''}`} key={num}>
                    <div className={`left-image${num > 1 ? num : ''}`}>
                        <img src={`pho${num > 1 ? num : ''}.avif`} alt="Trader" />
                        <div className={`right-content${num > 1 ? num : ''}`}>
                            <h2 className={`heading${num > 1 ? num : ''}`}>Standard</h2>
                            <h3 className={`subheading${num > 1 ? num : ''}`}>Create an account<br />in less than 5 minutes</h3>
                            <ul className={`features${num > 1 ? num : ''}`}>
                                <li>US$0 Minimum Deposit</li>
                                <li>Leverage up to 1:500</li>
                                <li>No Commissions</li>
                                <li>Swap free available</li>
                            </ul>
                            <button className={`create-btn${num > 1 ? num : ''}`}>Create Account</button>
                        </div>
                    </div>
                </div>
            ))}
