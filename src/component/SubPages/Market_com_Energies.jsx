...
import './Market_com_Energies.css';

function Market_com_Energies() {
        ...
        <div id='Main'>
            ...
            <section className="m-section">
                <div className="m-content">
                    <h1 className="m-title">Trade Energies</h1>
                    <p className="m-description">
                        Assets such as crude oil and natural gas are crucial to the global economy. At BlackBull Markets, we provide a range of energy CFDs with competitive spreads and favorable trading conditions.
                ...
                <div className="m-wrapper">
                    <img src="/public/subimg1.png" alt="Trading chart" className="m-image" />
                </div>
            </section>
            ...
            <div className="T-container">
                ...
                <div className="T-card-container">
                    <div className="T-card">
                        <img src="/public/subcard1.webp" alt="Supreme Court" className="T-card-image" />
                    ...
                    <div className="T-card">
                        <img src="/public/card1.webp" alt="BlackBull Markets" className="T-card-image" />
                        <div className="T-card-content">
                    ...
                    <div className="T-card">
                        <img src="/public/card2.webp" alt="Peso Resilience" className="T-card-image" />
                        <div className="T-card-content">
                    ...
                    <div className="T-card">
                        <img src="/public/card3.webp" alt="Dot Plot Divide" className="T-card-image" />
                        <div className="T-card-content">
...
export default Market_com_Energies;