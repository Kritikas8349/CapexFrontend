...
function CTraderFAQs() {
  ...
  return (
     <div className=' py-4 py-lg-5 py-md-5 pt-5  mt-lg-2 mx-lg-3 rounded rounded-4  bg-faq'>
      <div className='container align-items-start pt-5'>
        {/* <div className="d-flex"><span>Home &nbsp;</span>/&nbsp;<span>support&nbsp;</span>/&nbsp;<span>platform-support&nbsp;</span>/&nbsp;<span>secure client area</span></div> */}
        <div className='mb-1'>
          <h1 className='fw-bold text-center text-heading text-md-start'>CTrader</h1>
        </div>
