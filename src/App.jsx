...
//         </Routes>
      ...
      <div className='container1'>
        ...
        {/* <Routes>
          ...
          <Route path="/Equity-Research" element={<EquityResearch />}></Route>
          ...
          <Route path="/Technical-Analysis" element={<TechnicalAnalysis/>}></Route>
          <Route path="/Affiliate-Support" element={<Support1/>}></Route>
          <Route path="/IBs-Support" element={<Support2/>}></Route>
          <Route path="/Brand-Guidelines" element={<Support3/>}></Route> 
        </Routes> */}
       {/* <QuickStart/>
        <QuickStart3 />
        <QuickStart4 />
